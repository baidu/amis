...
| add          | `[name]: object` 新增的节点信息<br/>``items: object[]`选项集合（< 2.3.1 及以下版本 为`options`） | 新增节点提交时触发           |
| edit         | `[name]: object` 编辑的节点信息<br/>``items: object[]`选项集合（< 2.3.1 及以下版本 为`options`） | 编辑节点提交时触发           |
| delete       | `[name]: object` 编辑的节点信息<br/>``items: object[]`选项集合（< 2.3.1 及以下版本 为`options`） | 编辑节点提交时触发           |
