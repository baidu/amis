...
| add          | `[name]: Option` 新增的节点信息<br/>`options: Option[]` 选项集合 | 新增节点提交时触发           |
| edit         | `[name]: Option` 编辑的节点信息<br/>`options: Option[]` 选项集合 | 编辑节点提交时触发           |
| delete       | `[name]: Option` 编辑的节点信息<br/>`options: Option[]` 选项集合 | 编辑节点提交时触发           |
