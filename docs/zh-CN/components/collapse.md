...
| 事件名称       | 事件参数                                                                                                                                                                                                 | 说明                       |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| collapseChange | `activeKey: Array<string \| number>` 当前所有未折叠的折叠面板对应的索引值数组 <br /> `collapseId: string \| number` 触发事件的折叠面板对应的索引值 <br/> `collapsed: boolean` 触发事件的折叠面板是否折叠 | 折叠面板折叠状态改变时触发 |
