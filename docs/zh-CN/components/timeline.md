...
```json
{
  ...
  "data": {
      "items": [
        {"time": "2019-02-07", "title": "数据开发", "detail": "2019-02-07detail", "color":"red", "icon": "close"},
        {"time": "2019-02-08", "title": "管理中心", "detail": "2019-02-08detail" },
        {"time": "2019-02-09", "title": "SQL语句", "detail": "2019-02-09detail",  "color":"blue"},
...
|  mode   | `left` \| `right` \| `alternate`                                                            | `left`          | 指定文字相对于时间轴的位置，仅 direction=vertical时支持                  |
...
| detailCollapseText        | `string`                                | `展开`       | 详细内容折叠时按钮文案 |
| detailExpandText        | `string`                                | `折叠`       | 详细内容展开时按钮文案 |
