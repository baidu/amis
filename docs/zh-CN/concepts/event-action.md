...
| api / args.api`(>=v1.9.0-beta.13)`           | [API](../../../docs/types/api)      | -      | 接口配置                  |
| options / args.options`(>=v1.9.0-beta.13)`   | `object`                            | -      | 其他配置                  |
| messages / args.messages`(>=v1.9.0-beta.13)` | `{success: string, failed: string}` | -      | 请求成功/失败后的提示信息 |
...
| msg / args.msg`(>=v1.9.0-beta.13) ` | `string` | -       | 对话框提示内容 |
...
| title / args.title`(>=v1.9.0-beta.13)` | `string` | -               | 对话框标题     |
| msg / args.msg `(>=v1.9.0-beta.13)`    | `string` | -               | 对话框提示内容 |
...
| url / args.url`(>=v1.9.0-beta.13)`     | `string`  | -       | 按钮点击后，会打开指定页面。可用 `${xxx}` 取值。 |
| blank / args.blank`(>=v1.9.0-beta.13)` | `boolean` | `false` | 如果为 `true` 将在新 tab 页面打开。              |
...
| link / args.link`(>=v1.9.0-beta.13)` | `string` | `link` | 用来指定跳转地址，跟 url 不同的是，这是单页跳转方式，不会渲染浏览器，请指定 amis 平台内的页面。可用 `${xxx}` 取值。 |
...
| delta / args.delta`(>=v1.9.0-beta.13)` | `string` | `0`      | 位置            |
...
| msgType / args.msgType`(>=v1.9.0-beta.13)`         | `string`  | `"info"`                                | 消息类型 `"info"、"success"、"error"、"warning"`                                                                  |
| msg / args.msg`(>=v1.9.0-beta.13)`                 | `string`  | -                                       | 消息内容                                                                                                          |
| position / args.position`(>=v1.9.0-beta.13)`       | `string`  | `top-center（移动端为center）`          | 提示显示位置，可用'top-right'、'top-center'、'top-left'、'bottom-center'、'bottom-left'、'bottom-right'、'center' |
| closeButton / args.closeButton`(>=v1.9.0-beta.13)` | `boolean` | `false`                                 | 是否展示关闭按钮                                                                                                  |
| showIcon / args.showIcon`(>=v1.9.0-beta.13)`       | `boolean` | `true`                                  | 是否展示图标                                                                                                      |
| timeout / args.timeout`(>=v1.9.0-beta.13)`         | `number`  | `5000（error类型为6000，移动端为3000）` | 持续时间                                                                                                          |
...
| copyFormat / args.copyFormat`(>=v1.9.0-beta.13)` | `string`                             | `text/html` | 复制格式                             |
| content / args.content`(>=v1.9.0-beta.13)`       | [模板](../../docs/concepts/template) | -           | 指定复制的内容。可用 `${xxx}` 取值。 |
...
| to / args.to`(>=v1.9.0-beta.13)`           | `string` | -       | 收件人邮箱，可用 ${xxx} 取值。   |
| cc / args.cc`(>=v1.9.0-beta.13)`           | `string` | -       | 抄送邮箱，可用 ${xxx} 取值。     |
| bcc / args.bcc`(>=v1.9.0-beta.13)`         | `string` | -       | 匿名抄送邮箱，可用 ${xxx} 取值。 |
| subject / args.subject`(>=v1.9.0-beta.13)` | `string` | -       | 邮件主题，可用 ${xxx} 取值。     |
| body / args.body`(>=v1.9.0-beta.13)`       | `string` | -       | 邮件正文，可用 ${xxx} 取值。     |
...
| value / args.value`(>=v1.9.0-beta.13)` | `any`    | -          | 值                           |
...
通过配置`componentId`来触发指定组件的动作，组件动作参考通过`args`传入`(>=v1.9.0-beta.13)`，动作参数请查看对应的组件文档。
