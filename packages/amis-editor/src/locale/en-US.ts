...
extendLocale('en-US', {
  ...
  '3328813d737f9f5c9d24b39ca6e4a3c1': 'Data addition method',
  ...
  '26b5bd4947df8be257c59dde927b400c': 'Loading in progress ..',
  '977b11fe9834e54432d0c6724df89e04': 'Loading completed',
  '32452712d4d2a3d29865bc764a22ecfe': 'There is no more data available',
  'dacb05cb2e948e47c19df9b1cf63ab24': 'Total number segment name',
  'd6c6e029578569c4d0c3828ed0b6ae52': 'trigger',
  '4793ea431592921524fc31117e9a662e': 'loading',
  ...
  'c409adcc9f7ef3789c2f03c4da4295b5': 'presentation style',
  ...
  '2d5aef4f2443b4694bd1dcc434636c6e': 'go',
  ...
  'e2e0f5e01ebe60cbdd5d088fe3aecda4': 'Horizontal on the left',
  ...
  '9699a50e47f6c25c62851c06c5f05191': 'keyword',
  ...
  '94ec9e18c7faa520231cccecf4f4a77a': 'value',
  ...
  '507417dce637412e4f67cc9c651418d1': 'picture scale',
  ...
  'dcf6ca3fe486fd851d344fbe2b2a0327': 'line spacing',
  ...
  '5cab3e445ecabdd21be267f4b0654ee2': 'micro',
  ...
  '9d577fe51b38070678cad01e994931a6': 'File source',
  '5a878b8b32da24a3467d49a437d16936': 'file link',
  '7cfa34aea62c19462ee2074f58a74aa4': 'Local files',
  'bcf03e212f6351c863bb8ada2014aaa5': 'Link Address',
  ...
  '703cb4e22041256b9060d77a662ae22c': 'heading',
  ...
  'ac007746080a48f195815c62f8c1570c': 'auxiliary word for ordinal numbers',
  ...
  '4149ee3efdffed299e4b517a508b0469': 'DELETE',
  ...
  '2bbe5a93eeb01ef5970fddf84c101b0e':
    '<%= this.ignoreError === false ? Cannot find component and action execution failed both interrupted ": typeof this. ignoreError==" undefined "? Unable to find component tolerance, action execution failed before interrupting ":" "%>',
  ...
  '8b30d6b1df387b743772d949b66cf7fb': 'Global events',
  ...
  '1215dd0689aa1fdf89adbb9b7530a90e': 'Vertical scroll',
  ...
  '285b0d56e364277b24b72df4a1679427': 'spring back',
  ...
  '05853d9ceb108fc5434cdb1a34ab3fc3': 'Scale',
  ...
  'e660a1fb4de45e3bf6e6525ccd041821': 'vibrate',
  '9f6012f3eaff11a8721072cd5bfd7dbc': 'shake',
  'f1b8e0c6053ea917fbc702380bff9b73': 'shake',
  'c1754c2d14d1eb4f0d18eb4f3e6df78c': 'horizontal jitter',
  ...
  'bfc4ece391963e12c41642a276ed6413': 'wipe up',
  '8ed3fd614b90c33744173f1335468810': 'Slide Down',
  '9670b9e704c8424d6435965725b8a43b': 'Swipe left to',
  '674b6979771b5062aa7c68a3a484538b': 'Swipe right to',
  ...
  '631cd22018a47a2171c01d1c1c703261': 'confirm delete',
  ...
  'f407c6b6264be4b590e28085d392b73d': 'It can be dragged into the following area to fix the drag-and-drop container',
  '08fa5338e66f8607d9c0d3dcbc37dcaa': 'The defined style only takes effect for the current component. Example',
  '466073102fd0b34df5ef6fb64ce58e6d': 'Current level',
  '49e0c439b220b8fd476c01618bbe9d5d': 'Sub-level',
  'e5a08c7d964c509c3c3d4d5fcd7afc4d': 'Logical function',
  '563e4c1838fe9091e0a42f07d2710933': 'Mathematical function',
  'a65231cb753bf0cf89a322dbc776025c': 'Text function',
  '23c7d6860c8f1a6ec4951f311098eec0': 'Date function',
  '23740a12db47b2e0ecb3e94194453a44': 'Current layer',
  '5f49be98add60ea7dc0ef448dee01bc6': 'Parameter name',
  '531aadcd96c4f39b3e50e482e8dbd087': 'Numeric value',
  'ee53fd36c3d3f5c7307dd7866c15f104': 'Base number',
  'a225c0b6cb5b7c7ec9ffa7f86d082b6d': 'Exponent',
  'a6805f421af4ad6ba22d36ada035fb57': 'Conditional expressions. Example: Chinese score > 80',
  '2bbdbdd4e495145be0210f9dbbd51623': 'Return result when the condition judgment is passed',
  '68b470c1f89a1313fa7bd5a29711d236': 'Return result when the condition judgment is not passed',
  '6d6bb636f1caa983b547cfd0caea4f57': 'Conditional expressions; separate multiple ones with commas. Example: Chinese score > 80, math score > 80',
  'ddc6e94b207d7465ce32ed5b907d4463': 'Response value',
  'b721835196b7cd0388f26eca1e29b455': 'Dividend',
  '66bf2635583652f46b45ec8859dffc97': 'Number to be processed',
  '6716876653902c5711f0364f1c7c14d1': 'Decimal places, default is 2',
  'c43589967c920dc8b644404a180a5f88': 'The nth largest',
  'c658a5045c661b8064abfffd91107717': 'Text to be processed',
  '3c97998c5121a16ccb7b6627b2129749': 'Length to be processed',
  '7abb45429638849099d0a5d16c6f8091': 'Text collection',
  '5cbc2c618903149ce69e89080c72f159': 'Encoding value',
  'ec39e11c015cdf5f8b7292e7bce91258': 'Target length',
  'd2ff5f53df6082d30b5681b8848a8411': 'Text used for padding',
  '41c027b441251a3ff369f02b9d099104': 'Maximum length',
  'ac54d1ad363d3b0a590b757dcb43dd8f': 'End text',
  '9010ca471a618c302792670961633950': 'Text fragment',
  '5bdb0acfadd06cc34f24cf1a00e0dfee': 'Start text',
  '2ded20d31ce2b57857ce7707a5517211': 'Search text',
  '7cda5297ee5b6c8f0c44fe5660a79e6b': 'Text to be replaced',
  'af7a526b2f66f1dfa4f5e1360e1643bd': 'Replacement text',
  '2c4229d0c0c1f2f35c058e9b2e0ae3c6': 'Text used for searching',
  'b752a83f956234b32ed98ecbcf938dcb': 'Start position',
  '1c39cb6f3440fa567032737dd9fe0887': 'Processing length',
  'bbb34ce4fcf8cc55638791e2cd6b5a91': 'Length of the generated UUID string, default is 32 bits',
  '16d1cccaeee00a302b1284a42c32e7c6': 'Date object',
  '0f191c47fa745787b516857118a830f2': "Timestamp format; pass 'x' for milliseconds. Default is 'x’ (without milliseconds).",
  '86ed1903b0ecfd7dda0cf16eb2957d43': 'Week definition type, default is 1: 1 means 0-6 representing Monday to Sunday; 2 means 1-7 representing Monday to Sunday',
  'd454d85f6ec18741a81b952c5966da95': 'Whether it is an ISO week.',
  '97e0651009811538748c356255e04207': 'Date object, date string, timestamp',
  '28b47401285328e4f3344f8fe3b0b62c': 'Date format, default is \'YYYY-MM-DD HH:mm:ss\'',
  '01da6313d7f314dbb9b5a2ebcb07f982': 'Date range string',
  '9c4072c8df4d2e1c6a4a294f9b7d3cce': "Value identifier: 0 or 'start' means get start time; 1 or 'end' means get end time",
  '333abdc80f42fd3b7ae9eff39c0940a5': 'Date format (optional)',
  '05fcb8b62afd03022c7fcb58279c3cee': "Separator (optional), default is ','",
  'e6f158f9a9d3f173ac7ef6821b409ba3': "For example, you can pass 'day', 'month', 'year' or `week`, etc.",
  '7a8b4b22857357edf5a229d20e0b4d7f': 'Unit: supports year, month, day, etc.',
  '32a584643bc07bd1ef8e59d99af32e65': 'Date character',
  'e1a4848893698dd0710a9814c777c3a3': 'First date',
  '65fab49efb0fdab543457c89dbc9686f': 'Second date',
  '05a580edff795061ccd7a89009d6ac5a': "Unit, default is 'day' (compare up to the day)",
  'cd191a2ef9885e6b728a2d33a2b83a6c': "Inclusivity rule, default is '[]'. '[' means include; '(' means exclude. If using the inclusivity parameter, two indicators must be passed (e.g., '()' means both left and right ranges are excluded)",
  'd86f8699700a9690f06e275eca9446fb': 'Arrow function',
  'eeb2c63ecd94bbe0a2222fa639d6107d': 'Element',
  'b1b1bbfc69ba8ed14b4abcc420395b52': 'JS object',
  'cc4dd1da7e1a754534215f02fb9ba85d': 'String',
  '0602a35009a6d966925abd61e222b9a4': 'Object or array',
  '4f35e80da65927f09dd314de120fe5f9': 'Path',
  'c88e809e8a2d3fabefac87460441bc4e': 'Return this value if parsing fails',
  '001a0c4c814f782bd8b09c4ec56ac6f8': 'Judgment object',
  '75d4f99310ce6d885dfca27342babf3c': 'If condition is met, return consequent; otherwise return alternate. Support multi-level nested IF functions. Equivalent to using JS expression directly: condition? consequent : alternate.',
  '33136429f20612f8bbe72998c71ee8fe': 'If all conditions are met, return true; otherwise return false. Example: AND (Chinese score > 80, math score > 80): if both Chinese score and math score are greater than 80, return true; otherwise return false. Equivalent to JS expression: Chinese score > 80 && math score > 80.',
  '1aeeb99a79d7157e0f0ddd28298e9323': 'If any condition is met, return true; otherwise return false. Example: OR (Chinese score > 80, math score > 80): if either Chinese score or math score is greater than 80, return true; otherwise return false. Equivalent to JS expression: Chinese score > 80 || math score > 80.',
  '171db2606fa6338498d61e060fb35fa3': 'XOR processing: considered true if there is an odd number of true values among multiple expressions. Example: XOR (Chinese score > 80, math score > 80, English score > 80): if 1 or 3 of the three scores are greater than 80, return true; otherwise return false.',
  '4682a020956e97b8c0b7dc44cbc8e6b9': 'Judgment function collection, equivalent to combining multiple else if into one. Example: IFS (Chinese score > 80, \"Excellent\", Chinese score > 60, \"Good\", \"Keep trying\"): if Chinese score > 80, return \"Excellent\"; else if Chinese score > 60, return \"Good\"; else return \"Keep trying\".',
  'f9453bc31ac6fe8ef61a61a2850fa032': 'Return the absolute value of the input number.',
  '09a1d2393e17de145f9c262cb1c5e1d9': 'Get the maximum value. If there is only one parameter and it is an array, calculate the value within this array.',
  '7222f45e540b0657722bd4f7a54bcf22': 'Get the minimum value. If there is only one parameter and it is an array, calculate the value within this array.',
  '50a1a58c87881587606fb70bbc2153d2': 'Calculate the sum. If there is only one parameter and it is an array, calculate the value within this array.',
  '725841e49e7cee7e181be34045445c1f': 'Round the number down to the nearest integer.',
  'b846dbcd933827df3adbc3e670604f98': 'Return the remainder of dividing two numbers. The parameter \"number\" is the dividend, and the \"divisor\" is the divisor.',
  '62aa0442656d4fe0c0a3138126a5bd1f': 'Pi 3.1415...',
  'dc202add9d61722020749e8736171ff3': 'Round the number to the specified digit (decimal places can be set).',
  'ca7925a755cb56396b3ab1b9b63cf51e': 'Round the number down to the specified digit (decimal places can be set).',
  '7202f9d9bac24f0fadea86ac48ca7447': 'Round the number up to the specified digit (decimal places can be set).',
  '6d5e0d8f13fa0d2948e2eaf727db46b3': 'Calculate the square root. The parameter \"number\" must be non-negative',
  '61a86a9972e37fb43b2e22e42c6421ad': 'Return the average of all parameters. If there is only one parameter and it is an array, calculate the value within this array.',
  '0df788e02d17497a8b1c1483728ac1ea': 'Return the sum of squares of the differences between data points and the mean (data deviation). If there is only one parameter and it is an array, calculate the value within this array.',
  '4436a75ae004133fc666f673ec73e323': 'The average of the absolute deviations of data points from their arithmetic mean.',
  'f592f5392d9182d2b5c64e105dad789d': 'The harmonic mean of data points. If there is only one parameter and it is an array, calculate the value within this array.',
  '6fbd00a840f63b0561e5711309e527f4': 'The kth largest value in the dataset.',
  'e8074346fd95c461d504ee8caff98976': 'Convert the number to Chinese capitalized currency.',
  '546906596299e8cb04c44a8cd2e23ae5': 'Return a uniformly distributed random real number greater than or equal to 0 and less than 1. Change every time the calculation is triggered. Example: `RAND()*100`, return a random number between 0-100.',
  'c72b6cf156e72fafafadd8170595506b': 'Take the last item of the data.',
  '486a898cb178844dd6827e2da008d5cb': 'Return the base raised to the power of the exponent. The parameter \"base\" is the base number, and \"exponent\" is the exponent. If the parameter is invalid, return the base itself; if the calculation result is invalid, return NaN.',
  'ef12ca62598730039a2769f1159e7d6e': 'Return a substring of the specified length from the left side of the input text.',
  'e5dc2e9b87f1e2650d47ea4be1e0c0da': 'Return a substring of the specified length from the right side of the input text.',
  'd39df9c11954e0a3b9caf8151b0468b6': 'Calculate the length of the text.',
  '6338ad33d82fd64378dc1a769fb67fcc': 'Calculate the total length of all texts in the text collection.',
  '3fef88aa79db1e459fd57b3b443c6021': 'Determine whether the text is empty.',
  '71aedc291e97f05d45d1ff18c9b6db2d': 'Concatenate multiple input values into text.',
  '9a8dedae5832076dbaed75bb34e7fc24': 'Return the character corresponding to the numeric code in the computer’s character set. Example: `CHAR(97)` is equivalent to \"a\".',
  '250856f5d4dd4630f13b26987d616554': 'Convert the input text to lowercase.',
  '1f6c5305fbc67ee6480003118cd8db7a': 'Convert the input text to uppercase.',
  'a6cd8eab3e54f2248e82f21cfda5129a': 'Convert the first letter of the input text to uppercase.',
  '819eb11ba92c73ef238880f36a424610': 'Pad the text to the specified length from the start. Example: `PADSTART(\"6\", 2, \"0\")`, return `06`.',
  '72049f9ffcee4f1cdfe896b0973f2cff': 'Convert the text to title case. Example: `CAPITALIZE(\"star\")`, return `Star`.',
  '83d7079f27324f93712d0ad91ca31c8c': 'Escape the text for HTML. Example: `ESCAPE(\"<star>&\")`, return `&lt;start&gt;&amp;`.',
  '31c98d44caf88fa686e5dfe71d0e617b': 'Truncate the text by length. Example: `TRUNCATE(\"amis.baidu.com\", 6)`, return `amis...`.',
  '31070d1fd5242417dc836cd0a22f2775': 'Get all characters before a specific delimiter.',
  '45303b66f886943291c0910aebaed620': 'Split the text into an array by the specified segment. Example: `SPLIT(\"a,b,c\", \",\")`, return `[\"a\", \"b\", \"c\"]`.',
  'f567e1f33559d478df5780978825ebf2': 'Remove leading and trailing spaces from the text.',
  '3f6c03813d8a9cd2ca15eb571faa3644': 'Remove HTML tags from the text. Example: `STRIPTAG(\"<b>amis</b>\")`, return `amis`.',
  '777e5c82a6326e9ddc0a8b9ee2c3f8f1': 'Convert line breaks in the string to HTML (for simple line break scenarios). Example: `LINEBREAK(\"\n\")`, return `<br/>`.',
  '33324e6ef7140d16c7093b4b780f4cab': 'Determine if the string (text) starts with the specified string (startString): return true if yes, false otherwise.',
  'bb2ff3512e864e53e68723e562f3b4bc': 'Determine if the string (text) ends with the specified string (endString): return true if yes, false otherwise.',
  'f1a369e3432d6e8cd84d7802246cb364': 'Determine if the text in parameter 1 contains the text in parameter 2: return true if yes, false otherwise.',
  '695226ac1f1bce8cff96212b76d471f0': 'Replace all occurrences in the text.',
  '40de6ff6adf2b1c2f690708dd2f4f5b4': 'Search the text and return the position of the match.',
  'a8d68e49bcd165601e928772821ef9c6': 'Return a specific number of characters from the text string starting at the specified position. Example: `MID(\"amis.baidu.com\", 6, 3)`, return `aid`.',
  'fad1d635755dd8fb26d90b1ca0da003c': 'Return the filename from the path. Example: `/home/amis/a.json`, return `a.json`.',
  '045b831dd1fd3f25be4f1977bec9ef25': 'Generate UUID string',
  'fdd264ef6ebaadcdad6670dd782ebaaa': 'Create a data object via a string in a specific format or a numeric value. Note that the month value starts from 0: for example, pass 11 for December.',
  'f645d09319c41c57b376de89aec26bfb': 'Return the timestamp of the time.',
  'e9f3f3864b307b1a987e12a9d9463c61': 'Return today’s date.',
  'cd7f4db79a93aca2d00aee262420ed60': 'Return the current date',
  'fc4527e4de2f4b00368f124759ee7f47': "Get the day of the week for the date. Example: WEEKDAY('2023-02-27') returns 0. WEEKDAY('2023-02-27', 2) returns 1.",
  '653e1995b9360d5ea17adc62561fa1f2': "Get the week of the year (i.e., the week number). Example: WEEK('2023-03-05') returns 9.",
  '3d4ceadcf373d7f9ff18de20ccedd48d': "Format dates, date strings, and timestamps. Examples: DATETOSTR('12/25/2022', 'YYYY-MM-DD') returns '2022.12.25', DATETOSTR(1676563200, 'YYYY.MM.DD') returns '2023.02.17', DATETOSTR(1676563200000, 'YYYY.MM.DD hh:mm:ss') returns '2023.02.17 12:00:00', DATETOSTR(DATE('2021-12-21'), 'YYYY.MM.DD hh:mm:ss') returns '2021.12.21 08:00:00'.",
  'f97b5a4abd1d4b1dbf749ba26e9dd230': "Get the start time and end time from the data range string. Examples: DATERANGESPLIT('1676563200, 1676735999') returns [1676563200, 1676735999], DATERANGESPLIT('1676563200, 1676735999', undefined , 'YYYY.MM.DD hh:mm:ss') returns [2023.02.17 12:00:00, 2023.02.18 11:59:59], DATERANGESPLIT('1676563200, 1676735999', 0 , 'YYYY.MM.DD hh:mm:ss') returns '2023.02.17 12:00:00', DATERANGESPLIT('1676563200, 1676735999', 'start' , 'YYYY.MM.DD hh:mm:ss') returns '2023.02.17 12:00:00', DATERANGESPLIT('1676563200, 1676735999', 1 , 'YYYY.MM.DD hh:mm:ss') returns '2023.02.18 11:59:59', DATERANGESPLIT('1676563200, 1676735999', 'end' , 'YYYY.MM.DD hh:mm:ss') returns '2023.02.18 11:59:59'.",
  '279a4ea3129babc7fe5832aa64948c3c': 'Return the start of the specified range for the date.',
  'dbd33b41656f944366cab702b2be3b99': 'Return the end of the specified range for the date.',
  '3c0a1f86074fb104f9fcf2ec9280696c': 'Return the year of the date.',
  '82a490f5b376da13ac2ae5a39cb22c58': 'Return the month of the date (this refers to the natural month).',
  '874efb53592c95a1330bdd7e326cc4f7': 'Return the day of the date.',
  '8b0d15c3676bcf35c42254188a00e5a3': 'Return the hour of the date.',
  'c3d32687729d16ba031d457bcf9d7792': 'Return the minute of the date.',
  '8761f7078fbf5fce9d32b7a179b14ec4': 'Return the second of the date.',
  '1a261584c3c70020b4c5b02d31e8b1f7': 'Return the number of years between two dates.',
  '5a05af5aae5fcc038f29a403a18243a5': 'Return the number of minutes between two dates.',
  '8c202969efa5b5e48553760e07c73018': 'Return the number of hours between two dates.',
  '56b264e217aacf9fae37934497fae6bd': "Modify the date: perform operations like adding/subtracting days, months, years, etc. Example: DATEMODIFY(A, -2, 'month'): subtract 2 months from date A.",
  '7e2e144d81fb33ce97d3cfeedb3651c1': "Convert a string date to a date object; the date format can be specified. Example: STRTODATE('2021/12/6', 'YYYY/MM/DD')",
  '01ee2b469a0ed771b7d88d7f37da2775': 'Determine if the first date comes before the second date: return true if yes, false otherwise.',
  '8951f9f0e6aadf017cb894669aa487c7': 'Determine if the first date comes after the second date: return true if yes, false otherwise.',
  'f7728fb4212ce3d9dda0957df14d6fc5': "Determine if the date is within the specified range: return true if yes, false otherwise. Example: BETWEENRANGE('2021/12/6', ['2021/12/5','2021/12/7']).",
  'ec693de3a5d018aaa34148ab12807ce4': 'Determine if the first date is before or equal to the second date: return true if yes, false otherwise.',
  '9d5db4d0db5fdc0ba99baf44f1da69b5': 'Determine if the first date is after or equal to the second date: return true if yes, false otherwise.',
  '95624e7aad7ab31b21af28f2a22e8c41': 'Return the length of the array.',
  '61533e70a6220dea82052941e690c4b8': 'Transform array data; must be used with an arrow function (note: arrow functions only support single-expression syntax). Convert each element in the array to the value returned by the arrow function. Example: ARRAYMAP([1, 2, 3], item => item + 1) returns [2, 3, 4].',
  '3288dcc0e39872c6fd07911fd5946c4f': 'Filter array data; must be used with an arrow function (note: arrow functions only support single-expression syntax). Filter out members for which the arrow function returns false. Example: ARRAYFILTER([1, 2, 3], item => item > 1) returns [2, 3].',
  'e9dba27896aa5a79fd794a61c64c3124': 'Search array data; must be used with an arrow function (note: arrow functions only support single-expression syntax). Find the index of the member for which the arrow function returns true. Example: ARRAYFINDINDEX([0, 2, false], item => item === 2) returns 1.',
  '669d6b5340fc55359ed36bad85ca3c37': 'Search array data; must be used with an arrow function (note: arrow functions only support single-expression syntax). Find the member for which the arrow function returns true. Example: ARRAYFIND([0, 2, false], item => item === 2) returns 2.',
  '3785b0ca5ae801a018c941eb5ab7b541': 'Check array members via traversal; must be used with an arrow function (note: arrow functions only support single-expression syntax). Determine if there is any member for which the arrow function returns true: return true if yes, false otherwise. Example: ARRAYSOME([0, 2, false], item => item === 2) returns true.',
  '2e47575507eb5ebadb9bd5ffc01ac12c': 'When performing data traversal and evaluation, it is necessary to use arrow functions. Note that arrow functions only support single-expression syntax. The evaluation checks whether the return values of the second arrow function are all true; if so, it returns true, otherwise it returns false. Example: ARRAYEVERY([0, 2, false], item => item === 2) returns false.',
  '27e200e541b31e5aca38eb7d8f12667f': 'Determine if the specified element exists in the data. Example: ARRAYINCLUDES([0, 2, false], 2) returns true.',
  '7ada9f67416ea16540fcb61725e2397f': "Filter out false, null, 0 and \"\" from the array. Example: COMPACT([0, 1, false, 2, '', 3]) returns [1, 2, 3].",
  '0b82c69331128197f5653deabe707aee': "Convert the array to a string. Example: JOIN(['a', 'b', 'c'], '=') returns 'a=b=c'.",
  'a2ef05f1e4a8af0d5c380307d2cc3cce': "Merge arrays. Example: CONCAT(['a', 'b', 'c'], ['1'], ['3']) returns ['a', 'b', 'c', '1', '3'].",
  '3c227600a4af0574e8782e96455862a9': "Remove duplicates from the array; the second parameter 「field」 allows specifying a field to deduplicate by. Example: UNIQ([{a: '1'}, {b: '2'}, {a: '1'}]) returns [{a: '1'}, {b: '2'}].",
  'b90e85a6f375f73dcc262c0803fbf7af': "Convert a JS object to a JSON string. Example: ENCODEJSON({name: 'amis'}) returns '{\\\"name\\\":\\\"amis\\\"}'.",
  '3effcacff99f8e3a6c560990bc0c5e7b': "Parse JSON-encoded data and return a JS object. Example: DECODEJSON('{\\\"name\\\": \"amis\"}') returns {name: 'amis'}.",
  'e2ef119aeea89c0978c98125d3647c6b': "Get the value from an object or array using a path. If the parsed value is undefined, it will be replaced with defaultValue. Example: GET([0, 2, {name: 'amis', age: 18}], 1) returns 2, GET([0, 2, {name: 'amis', age: 18}], '2.name') returns 'amis', GET({arr: [{name: 'amis', age: 18}]}, 'arr[0].name') returns 'amis', GET({arr: [{name: 'amis', age: 18}]}, 'arr.0.name') returns 'amis', GET({arr: [{name: 'amis', age: 18}]}, 'arr.1.name', 'not-found') returns 'not-found'.",
  '595574852a6aef47b344381515745911': 'Check if the type is supported: string, number, array, date, plain-object.'
});
