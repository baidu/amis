...
extendLocale('zh-CN', {
  ...
  '08fa5338e66f8607d9c0d3dcbc37dcaa': '定义样式仅对当前组件生效。示例',
  '466073102fd0b34df5ef6fb64ce58e6d': '当前层级',
  '49e0c439b220b8fd476c01618bbe9d5d': '子层级',
  'e5a08c7d964c509c3c3d4d5fcd7afc4d': '逻辑函数',
  '563e4c1838fe9091e0a42f07d2710933': '数学函数',
  'a65231cb753bf0cf89a322dbc776025c': '文本函数',
  '23c7d6860c8f1a6ec4951f311098eec0': '日期函数',
  '23740a12db47b2e0ecb3e94194453a44': '当前层',
  '5f49be98add60ea7dc0ef448dee01bc6': '参数名称',
  '531aadcd96c4f39b3e50e482e8dbd087': '数值',
  'ee53fd36c3d3f5c7307dd7866c15f104': '基数',
  'a225c0b6cb5b7c7ec9ffa7f86d082b6d': '指数',
  'a6805f421af4ad6ba22d36ada035fb57': '条件表达式。例如：语文成绩>80',
  '2bbdbdd4e495145be0210f9dbbd51623': '条件判断通过的返回结果',
  '68b470c1f89a1313fa7bd5a29711d236': '条件判断不通过的返回结果',
  '6d6bb636f1caa983b547cfd0caea4f57': '条件表达式，多个用逗号隔开。例如：语文成绩>80, 数学成绩>80',
  'ddc6e94b207d7465ce32ed5b907d4463': '返回值',
  'b721835196b7cd0388f26eca1e29b455': '被除数',
  '66bf2635583652f46b45ec8859dffc97': '要处理的数字',
  '6716876653902c5711f0364f1c7c14d1': '小数位数，默认为2',
  'c43589967c920dc8b644404a180a5f88': '第几大',
  'c658a5045c661b8064abfffd91107717': '要处理的文本',
  '3c97998c5121a16ccb7b6627b2129749': '要处理的长度',
  '7abb45429638849099d0a5d16c6f8091': '文本集合',
  '5cbc2c618903149ce69e89080c72f159': '编码值',
  'ec39e11c015cdf5f8b7292e7bce91258': '目标长度',
  'd2ff5f53df6082d30b5681b8848a8411': '用于补齐的文本',
  '41c027b441251a3ff369f02b9d099104': '最长长度',
  'ac54d1ad363d3b0a590b757dcb43dd8f': '结束文本',
  '9010ca471a618c302792670961633950': '文本片段',
  '5bdb0acfadd06cc34f24cf1a00e0dfee': '起始文本',
  '2ded20d31ce2b57857ce7707a5517211': '搜索文本',
  '7cda5297ee5b6c8f0c44fe5660a79e6b': '要被替换的文本',
  'af7a526b2f66f1dfa4f5e1360e1643bd': '要替换的文本',
  '2c4229d0c0c1f2f35c058e9b2e0ae3c6': '用来搜索的文本',
  'b752a83f956234b32ed98ecbcf938dcb': '起始位置',
  '1c39cb6f3440fa567032737dd9fe0887': '处理长度',
  'bbb34ce4fcf8cc55638791e2cd6b5a91': '生成的UUID字符串长度，默认为32位',
  '16d1cccaeee00a302b1284a42c32e7c6': '日期对象',
  '0f191c47fa745787b516857118a830f2': "时间戳格式，带毫秒传入 'x'。默认为 'X' 不带毫秒的。",
  '86ed1903b0ecfd7dda0cf16eb2957d43': '星期定义类型，默认为1，1表示0至6代表星期一到星期日，2表示1至7代表星期一到星期日',
  'd454d85f6ec18741a81b952c5966da95': '是否ISO星期',
  '97e0651009811538748c356255e04207': '日期对象、日期字符串、时间戳',
  '28b47401285328e4f3344f8fe3b0b62c': '日期格式，默认为 \"YYYY-MM-DD HH:mm:ss\"',
  '01da6313d7f314dbb9b5a2ebcb07f982': '日期范围字符串',
  '9c4072c8df4d2e1c6a4a294f9b7d3cce': "取值标识，0或'start'表示获取开始时间，1或'end'表示获取结束时间",
  '333abdc80f42fd3b7ae9eff39c0940a5': '日期格式，可选',
  '05fcb8b62afd03022c7fcb58279c3cee': "分隔符，可选，默认为','",
  'e6f158f9a9d3f173ac7ef6821b409ba3': "比如可以传入 'day'、'month'、'year' 或者 `week` 等等",
  '7a8b4b22857357edf5a229d20e0b4d7f': '单位：支持年、月、天等等',
  '32a584643bc07bd1ef8e59d99af32e65': '日期字符',
  'e1a4848893698dd0710a9814c777c3a3': '第一个日期',
  '65fab49efb0fdab543457c89dbc9686f': '第二个日期',
  '05a580edff795061ccd7a89009d6ac5a': "单位，默认是 'day'， 即之比较到天",
  'cd191a2ef9885e6b728a2d33a2b83a6c': "包容性规则，默认为'[]'。[ 表示包含、( 表示排除，如果使用包容性参数，则必须传入两个指示符，如'()'表示左右范围都排除",
  'd86f8699700a9690f06e275eca9446fb': '箭头函数',
  'eeb2c63ecd94bbe0a2222fa639d6107d': '元素',
  'b1b1bbfc69ba8ed14b4abcc420395b52': 'JS对象',
  'cc4dd1da7e1a754534215f02fb9ba85d': '字符串',
  '0602a35009a6d966925abd61e222b9a4': '对象或数组',
  '4f35e80da65927f09dd314de120fe5f9': '路径',
  'c88e809e8a2d3fabefac87460441bc4e': '如果解析不到则返回该值',
  '001a0c4c814f782bd8b09c4ec56ac6f8': '判断对象',
  '75d4f99310ce6d885dfca27342babf3c': '如果满足条件condition，则返回consequent，否则返回alternate，支持多层嵌套IF函数。 等价于直接用JS表达式如：condition ? consequent : alternate。',
  '33136429f20612f8bbe72998c71ee8fe': '条件全部符合，返回 true，否则返回 false。 示例：AND(语文成绩>80, 数学成绩>80)， 语文成绩和数学成绩都大于 80，则返回 true，否则返回 false， 等价于直接用JS表达式如：语文成绩>80 && 数学成绩>80。',
  '1aeeb99a79d7157e0f0ddd28298e9323': '条件任意一个满足条件，返回 true，否则返回 false。 示例：OR(语文成绩>80, 数学成绩>80)， 语文成绩和数学成绩任意一个大于 80，则返回 true，否则返回 false， 等价于直接用JS表达式如：语文成绩>80 || 数学成绩>80。',
  '171db2606fa6338498d61e060fb35fa3': '异或处理，多个表达式组中存在奇数个真时认为真。 示例：XOR(语文成绩 > 80, 数学成绩 > 80, 英语成绩 > 80) 三门成绩中有一门或者三门大于 80，则返回 true，否则返回 false。',
  '4682a020956e97b8c0b7dc44cbc8e6b9': '判断函数集合，相当于多个 else if 合并成一个。 示例：IFS(语文成绩 > 80, \"优秀\", 语文成绩 > 60, \"良\", \"继续努力\")， 如果语文成绩大于 80，则返回优秀，否则判断大于 60 分，则返回良，否则返回继续努力。',
  'f9453bc31ac6fe8ef61a61a2850fa032': '返回传入数字的绝对值。',
  '09a1d2393e17de145f9c262cb1c5e1d9': '获取最大值，如果只有一个参数且是数组，则计算这个数组内的值。',
  '7222f45e540b0657722bd4f7a54bcf22': '获取最小值，如果只有一个参数且是数组，则计算这个数组内的值。',
  '50a1a58c87881587606fb70bbc2153d2': '求和，如果只有一个参数且是数组，则计算这个数组内的值。',
  '725841e49e7cee7e181be34045445c1f': '将数值向下取整为最接近的整数。',
  'b846dbcd933827df3adbc3e670604f98': '返回两数相除的余数，参数 number 是被除数，divisor 是除数。',
  '62aa0442656d4fe0c0a3138126a5bd1f': '圆周率 3.1415...。',
  'dc202add9d61722020749e8736171ff3': '将数字四舍五入到指定的位数，可以设置小数位。',
  'ca7925a755cb56396b3ab1b9b63cf51e': '将数字向下取整到指定的位数，可以设置小数位。',
  '7202f9d9bac24f0fadea86ac48ca7447': '将数字向上取整到指定的位数，可以设置小数位。',
  '6d5e0d8f13fa0d2948e2eaf727db46b3': '开平方，参数 number 为非负数',
  '61a86a9972e37fb43b2e22e42c6421ad': '返回所有参数的平均值，如果只有一个参数且是数组，则计算这个数组内的值。',
  '0df788e02d17497a8b1c1483728ac1ea': '返回数据点与数据均值点之差（数据偏差）的平方和，如果只有一个参数且是数组，则计算这个数组内的值。',
  '4436a75ae004133fc666f673ec73e323': '数据点到其算术平均值的绝对偏差的平均值。',
  'f592f5392d9182d2b5c64e105dad789d': '数据点的调和平均值，如果只有一个参数且是数组，则计算这个数组内的值。',
  '6fbd00a840f63b0561e5711309e527f4': '数据集中第 k 个最大值。',
  'e8074346fd95c461d504ee8caff98976': '将数值转为中文大写金额。',
  '546906596299e8cb04c44a8cd2e23ae5': '返回大于等于 0 且小于 1 的均匀分布随机实数。每一次触发计算都会变化。 示例：`RAND()*100`， 返回 0-100 之间的随机数。',
  'c72b6cf156e72fafafadd8170595506b': '取数据最后一个。',
  '486a898cb178844dd6827e2da008d5cb': '返回基数的指数次幂，参数base为基数，exponent为指数，如果参数值不合法则返回基数本身，计算结果不合法，则返回NaN。',
  'ef12ca62598730039a2769f1159e7d6e': '返回传入文本左侧的指定长度字符串。',
  'e5dc2e9b87f1e2650d47ea4be1e0c0da': '返回传入文本右侧的指定长度字符串。',
  'd39df9c11954e0a3b9caf8151b0468b6': '计算文本的长度。',
  '6338ad33d82fd64378dc1a769fb67fcc': '计算文本集合中所有文本的长度。',
  '3fef88aa79db1e459fd57b3b443c6021': '判断文本是否为空。',
  '71aedc291e97f05d45d1ff18c9b6db2d': '将多个传入值连接成文本。',
  '9a8dedae5832076dbaed75bb34e7fc24': '返回计算机字符集的数字代码所对应的字符。 示例：`CHAR(97)` 等价于 \"a\"。',
  '250856f5d4dd4630f13b26987d616554': '将传入文本转成小写。',
  '1f6c5305fbc67ee6480003118cd8db7a': '将传入文本转成大写。',
  'a6cd8eab3e54f2248e82f21cfda5129a': '将传入文本首字母转成大写。',
  '819eb11ba92c73ef238880f36a424610': '向前补齐文本长度。 示例 `PADSTART(\"6\", 2, \"0\")`， 返回 `06`。',
  '72049f9ffcee4f1cdfe896b0973f2cff': '将文本转成标题。 示例 `CAPITALIZE(\"star\")`， 返回 `Star`。',
  '83d7079f27324f93712d0ad91ca31c8c': '对文本进行 HTML 转义。 示例 `ESCAPE(\"<star>&\")`， 返回 `&lt;start&gt;&amp;`。',
  '31c98d44caf88fa686e5dfe71d0e617b': '对文本长度进行截断。 示例 `TRUNCATE(\"amis.baidu.com\", 6)`， 返回 `amis...`。',
  '31070d1fd5242417dc836cd0a22f2775': '取在某个分隔符之前的所有字符串。',
  '45303b66f886943291c0910aebaed620': '将文本根据指定片段分割成数组。 示例：`SPLIT(\"a,b,c\", \",\")`， 返回 `[\"a\", \"b\", \"c\"]`。',
  'f567e1f33559d478df5780978825ebf2': '将文本去除前后空格。',
  '3f6c03813d8a9cd2ca15eb571faa3644': '去除文本中的 HTML 标签。 示例：`STRIPTAG(\"<b>amis</b>\")`， 返回：`amis`。',
  '777e5c82a6326e9ddc0a8b9ee2c3f8f1': '将字符串中的换行转成 HTML `<br>`，用于简单换行的场景。 示例：`LINEBREAK(\"\n\")`， 返回：`<br/>`。',
  '33324e6ef7140d16c7093b4b780f4cab': '判断字符串(text)是否以特定字符串(startString)开始，是则返回 true，否则返回 false。',
  'bb2ff3512e864e53e68723e562f3b4bc': '判断字符串(text)是否以特定字符串(endString)结束，是则返回 true，否则返回 false。',
  'f1a369e3432d6e8cd84d7802246cb364': '判断参数 1 中的文本是否包含参数 2 中的文本，是则返回 true，否则返回 false。',
  '695226ac1f1bce8cff96212b76d471f0': '对文本进行全量替换。',
  '40de6ff6adf2b1c2f690708dd2f4f5b4': '对文本进行搜索，返回命中的位置。',
  'a8d68e49bcd165601e928772821ef9c6': '返回文本字符串中从指定位置开始的特定数目的字符。 示例：`MID(\"amis.baidu.com\", 6, 3)`， 返回 `aid`。',
  'fad1d635755dd8fb26d90b1ca0da003c': '返回路径中的文件名。 示例：`/home/amis/a.json`， 返回：`a.json`。',
  '045b831dd1fd3f25be4f1977bec9ef25': '生成UUID字符串',
  'fdd264ef6ebaadcdad6670dd782ebaaa': '创建日期对象，可以通过特定格式的字符串，或者数值。 需要注意的是，其中月份的数值是从0开始的， 即如果是12月份，你应该传入数值11。',
  'f645d09319c41c57b376de89aec26bfb': '返回时间的时间戳。',
  'e9f3f3864b307b1a987e12a9d9463c61': '返回今天的日期。',
  'cd7f4db79a93aca2d00aee262420ed60': '返回现在的日期',
  'fc4527e4de2f4b00368f124759ee7f47': "获取日期的星期几。 示例 WEEKDAY('2023-02-27') 得到 0。 WEEKDAY('2023-02-27', 2) 得到 1。",
  '653e1995b9360d5ea17adc62561fa1f2': "获取年份的星期，即第几周。 示例 WEEK('2023-03-05') 得到 9。",
  '3d4ceadcf373d7f9ff18de20ccedd48d': "对日期、日期字符串、时间戳进行格式化。 示例 DATETOSTR('12/25/2022', 'YYYY-MM-DD') 得到 '2022.12.25'， DATETOSTR(1676563200, 'YYYY.MM.DD') 得到 '2023.02.17'， DATETOSTR(1676563200000, 'YYYY.MM.DD hh:mm:ss') 得到 '2023.02.17 12:00:00'， DATETOSTR(DATE('2021-12-21'), 'YYYY.MM.DD hh:mm:ss') 得到 '2021.12.21 08:00:00'。",
  'f97b5a4abd1d4b1dbf749ba26e9dd230': "获取日期范围字符串中的开始时间、结束时间。 示例： DATERANGESPLIT('1676563200, 1676735999') 得到 [1676563200, 1676735999]， DATERANGESPLIT('1676563200, 1676735999', undefined , 'YYYY.MM.DD hh:mm:ss') 得到 [2023.02.17 12:00:00, 2023.02.18 11:59:59]， DATERANGESPLIT('1676563200, 1676735999', 0 , 'YYYY.MM.DD hh:mm:ss') 得到 '2023.02.17 12:00:00'， DATERANGESPLIT('1676563200, 1676735999', 'start' , 'YYYY.MM.DD hh:mm:ss') 得到 '2023.02.17 12:00:00'， DATERANGESPLIT('1676563200, 1676735999', 1 , 'YYYY.MM.DD hh:mm:ss') 得到 '2023.02.18 11:59:59'， DATERANGESPLIT('1676563200, 1676735999', 'end' , 'YYYY.MM.DD hh:mm:ss') 得到 '2023.02.18 11:59:59'。",
  '279a4ea3129babc7fe5832aa64948c3c': '返回日期的指定范围的开端。',
  'dbd33b41656f944366cab702b2be3b99': '返回日期的指定范围的末尾。',
  '3c0a1f86074fb104f9fcf2ec9280696c': '返回日期的年份。',
  '82a490f5b376da13ac2ae5a39cb22c58': '返回日期的月份，这里就是自然月份。',
  '874efb53592c95a1330bdd7e326cc4f7': '返回日期的天。',
  '8b0d15c3676bcf35c42254188a00e5a3': '返回日期的小时。',
  'c3d32687729d16ba031d457bcf9d7792': '返回日期的分。',
  '8761f7078fbf5fce9d32b7a179b14ec4': '返回日期的秒。',
  '1a261584c3c70020b4c5b02d31e8b1f7': '返回两个日期相差多少年。',
  '5a05af5aae5fcc038f29a403a18243a5': '返回两个日期相差多少分钟。',
  '8c202969efa5b5e48553760e07c73018': '返回两个日期相差多少小时。',
  '56b264e217aacf9fae37934497fae6bd': "修改日期，对日期进行加减天、月份、年等操作。 示例： DATEMODIFY(A, -2, 'month')， 对日期 A 进行往前减2月的操作。",
  '7e2e144d81fb33ce97d3cfeedb3651c1': "将字符日期转成日期对象，可以指定日期格式。 示例：STRTODATE('2021/12/6', 'YYYY/MM/DD')",
  '01ee2b469a0ed771b7d88d7f37da2775': '判断两个日期，是否第一个日期在第二个日期的前面，是则返回 true，否则返回 false。',
  '8951f9f0e6aadf017cb894669aa487c7': '判断两个日期，是否第一个日期在第二个日期的后面，是则返回 true，否则返回 false。',
  'f7728fb4212ce3d9dda0957df14d6fc5': "判断日期是否在指定范围内，是则返回 true，否则返回 false。 示例：BETWEENRANGE('2021/12/6', ['2021/12/5','2021/12/7'])。",
  'ec693de3a5d018aaa34148ab12807ce4': '判断两个日期，是否第一个日期在第二个日期的前面或者相等，是则返回 true，否则返回 false。',
  '9d5db4d0db5fdc0ba99baf44f1da69b5': '判断两个日期，是否第一个日期在第二个日期的后面或者相等，是则返回 true，否则返回 false。',
  '95624e7aad7ab31b21af28f2a22e8c41': '返回数组的长度。',
  '61533e70a6220dea82052941e690c4b8': '数组做数据转换，需要搭配箭头函数一起使用，注意箭头函数只支持单表达式用法。 将数组中的每个元素转换成箭头函数返回的值。 示例： ARRAYMAP([1, 2, 3], item => item + 1) 得到 [2, 3, 4]。',
  '3288dcc0e39872c6fd07911fd5946c4f': '数据做数据过滤，需要搭配箭头函数一起使用，注意箭头函数只支持单表达式用法。 将第二个箭头函数返回为 false 的成员过滤掉。 示例： ARRAYFILTER([1, 2, 3], item => item > 1) 得到 [2, 3]。',
  'e9dba27896aa5a79fd794a61c64c3124': '数据做数据查找，需要搭配箭头函数一起使用，注意箭头函数只支持单表达式用法。 找出第二个箭头函数返回为 true 的成员的索引。 示例： ARRAYFINDINDEX([0, 2, false], item => item === 2) 得到 1。',
  '669d6b5340fc55359ed36bad85ca3c37': '数据做数据查找，需要搭配箭头函数一起使用，注意箭头函数只支持单表达式用法。 找出第二个箭头函数返回为 true 的成员。 示例： ARRAYFIND([0, 2, false], item => item === 2) 得到 2。',
  '3785b0ca5ae801a018c941eb5ab7b541': '数据做数据遍历判断，需要搭配箭头函数一起使用，注意箭头函数只支持单表达式用法。 判断第二个箭头函数是否存在返回为 true 的成员，是则返回 true，否则返回 false。 示例： ARRAYSOME([0, 2, false], item => item === 2) 得到 true。',
  '2e47575507eb5ebadb9bd5ffc01ac12c': '数据做数据遍历判断，需要搭配箭头函数一起使用，注意箭头函数只支持单表达式用法。 判断第二个箭头函数返回是否都为 true，是则返回 true，否则返回 false。 示例： ARRAYEVERY([0, 2, false], item => item === 2) 得到 false',
  '27e200e541b31e5aca38eb7d8f12667f': '判断数据中是否存在指定元素。 示例： ARRAYINCLUDES([0, 2, false], 2) 得到 true。',
  '7ada9f67416ea16540fcb61725e2397f': "数组过滤掉 false、null、0 和 \"\"。 示例： COMPACT([0, 1, false, 2, '', 3]) 得到 [1, 2, 3]。",
  '0b82c69331128197f5653deabe707aee': "数组转成字符串。 示例： JOIN(['a', 'b', 'c'], '=') 得到 'a=b=c'。",
  'a2ef05f1e4a8af0d5c380307d2cc3cce': "数组合并。 示例： CONCAT(['a', 'b', 'c'], ['1'], ['3']) 得到 ['a', 'b', 'c', '1', '3']。",
  '3c227600a4af0574e8782e96455862a9': "数组去重，第二个参数「field」，可指定根据该字段去重。 示例： UNIQ([{a: '1'}, {b: '2'}, {a: '1'}]) 得到 [{a: '1'}, {b: '2'}]。",
  'b90e85a6f375f73dcc262c0803fbf7af': "将JS对象转换成JSON字符串。 示例： ENCODEJSON({name: 'amis'}) 得到 '{\\\"name\\\":\\\"amis\\\"}'。",
  '3effcacff99f8e3a6c560990bc0c5e7b': "解析JSON编码数据，返回JS对象。 示例： DECODEJSON('{\\\"name\\\": \"amis\"}') 得到 {name: 'amis'}。",
  'e2ef119aeea89c0978c98125d3647c6b': "根据对象或者数组的path路径获取值。 如果解析 value 是 undefined 会以 defaultValue 取代。 示例： GET([0, 2, {name: 'amis', age: 18}], 1) 得到 2， GET([0, 2, {name: 'amis', age: 18}], '2.name') 得到 'amis'， GET({arr: [{name: 'amis', age: 18}]}, 'arr[0].name') 得到 'amis'， GET({arr: [{name: 'amis', age: 18}]}, 'arr.0.name') 得到 'amis'， GET({arr: [{name: 'amis', age: 18}]}, 'arr.1.name', 'not-found') 得到 'not-found'。",
  '595574852a6aef47b344381515745911': '判断是否为类型支持：string, number, array, date, plain-object。'
});
