...
extendLocale('zh-CN', {
  ...
  'd6f555510792c9f3cb9e8087af037898': '数据映射中存在错误，请仔细检查',
  'c14ebcefcb02c97b925b762d8bacd1ee': '按 Esc 关闭弹框',
  '4cade75641878a17e2f1ff29ff0ac235': '点击弹框外区域关闭弹框',
  ...
  '5831b836c8132033f90b3f530fa433db': '是否显示关闭按钮',
  '79e5818b205352166231217ea39c4f1f': '顶部 CSS 类名',
  ...
  '81b8345bc49ce2aa550ad9792acec3e9': '定义弹框从什么位置呼出',
  '399f43daffee1afae2a881027b6fb1f9': '点击外部关闭弹框',
  'b09cb613b11a41f3b3804d9c75da90b1': '按 Esc 可关闭',
  '6d7f8b31caaf80deb65eb2c8bdd41cd7': '超小',
  'b90f6c7021e444a34a00fcba6a428762': '是否显示蒙层',
  '07e8695e6142a6e50b323c3d5aae2101': '可拉拽',
  '0fad5a56c8b4643f24797eaa616bef6f': '定义弹框是否可拉拽调整大小',
  '7fdaa90d63dd5163de1911264bc5c514': 'bodyClassName 类名',
  ...
  '295afc11c5fad1a6d97ae174abfcc5bf': '文件值变化',
  'd4633ba7a30303a59891d051a7715cc9': '开启后，不能同时开启裁剪功能',
  '22616e32a895c56187921ac6cc673f51': '图片最大体积',
  '13446481eaf0a047d8fddf159d981a7c': '超出大小不允许上传，单位字节',
  'aeae3dd09f5cc972944a892802244483': '图片最大数量',
  'eec48d0e729f7260544646c60ef6580d': '超出数量不允许上传',
  ...
  '886df74c6a38c09891f46bd029490ae7': '是否开启固定尺寸',
  ...
  '5d8ff202988e28795bc72ab60d67d79d': '压缩配置',
  '99b57d8c9244ff9a695fcd519b4e2e57': '最大宽度',
  'fc2bc4193eea63128961d09497e07dc8': '最大高度',
  'd4efa8f599c1effe67bf6a7f38a9c40d': '是否显示压缩选项',
  'f8a68f636880acd097317f16aeacaedc': '是否开启裁剪',
  '3d948d24bc4c29689c5a1d4bcb9f2b98': '开启后，不能同时开启多选模式',
  'e09f3466f78e62c1494fb36816950501': '裁剪比率',
  'ea172e50aedd5afb561ef02ca119821c': '裁剪时是否可旋转',
  'ae948ea02f5abf3c6409b1c3fe3a2295': '裁剪时否可缩放',
  '4697838df60efb48d857c12387c6d795': '裁剪区域限制',
  'bc436447f54b10a9ac3f0ee3e1b863dc': '无限制',
  '7ccc0313ac4c40b364f482341ecc3bb8': '绘图区域',
  '4db4c540f05524c38e9431173736517b': '图片限制',
  '93f0c741d286a0353f95afa4a8aeff64': '限制宽度',
  '5738784edf25dd7c3e40e0c1af4dc80a': '限制高度',
  '367e853038270c93e2c35a2bfdf0bcb5': '限制最大宽度',
  '3693431e7944d7d46959b44b93de894c': '限制最大高度',
  '37494f474367871edc678cd5f4fc8ea8': '限制最小宽度',
  '484abb6891d6ea842c58e5ada6dbf411': '限制最小高度',
  '9b43b6d003635fbf2e02f9bab12929a5': '限制宽高比率',
  ...
  '7dae2e2c470a12011e0c8b831506f656': '隐藏顶级',
  'feec2a81557811b7fc38b0e6b758c3f7': '是否显示图标',
  '018d13580184c6ca3df616940ebaee66': '不自动选中子节点',
  '210bc6834481c05ed90875d87a262ed5': '选中父级时，孩子节点是否自动选中',
  ...
  'b51b404751554341aae342bc5a6e9b22': '左侧的标题文字',
  'c7840604d79e814f02f8260bc2ba6544': '右侧结果的标题文字',
  ...
  '0ba83d9fe027d8386b814f4966f20d4e': '勾选展示模式',
  '847fe7c3978764607631845b0a43926b': '关联选择形式',
  '9037f708f0d9750505aa741399768ac0': '左边的选项集',
  '3dd8d112997a8d0ae0641b8bf69eb7ff': '左侧选择形式',
  '7980e24e70a7e56490fa397d5bc6b86a': '右侧选择形式',
  'baf916e9b0de774b78e716e91b963690': '是否显示统计数据',
  ...
  'cfd5faa079bd9d7092e7cdc92f353c30': '自动完成接口',
  'a9f97c7c1bec32a0912f1dd36b2c3b90':
    '每次输入新内容后，将调用接口，根据接口返回更新选项。当前用户输入值在 `\\${term}` 中。<code>请不要与获取选项接口同时设置。</code>',
  '72cd009894ef3ea735d5e2a9b4656c04': '是否默认展开子选项',
  '0770f4a4a4f769d778ffe228675e8c3a': '选项默认展开级数',
  'd1b65ac6a715ec342d7b738c64b55aa0': '新增选项接口',
  '07e2cb845d6b6c3f91e6960c209b36da': '编辑选项接口',
  '8c05730667f91c371ace46c17f46c875': '删除选项接口',
  ...
  'ac82acdf2f38faaf293c8690b2ea627f': '数据初始化接口',
  ...
  '4e5640b31caf3326c27026bd1ed8f4cb': '头部CSS类名',
  'e656f261cac36cc658e8d69973d7611d': '内容CSS类名',
  '1444bd7ae7b7301b6edf930c2ab8b175': '边栏CSS类名',
  'dbe33f485b394a3e77240c530b9965e4': '工具栏CSS类名',
  '674be25c9feffcf78eba48d53a944148': '移动端下拉刷新',
  ...
  'c9fc9b668c08d0e54415c7054d414651': '分页类型',
  '35242cff1266fd3610f124b0e5e76f9b': '普通',
  '40e49965594422b15ddd789eef4dda7e': '简易',
  'da184573d7eac6362e01e6fb202d3c91': '分页布局展示',
  '7c94d517ef4d6633144d5c719d0019d0':
    '选中表示渲染该项，可以拖拽排序调整显示的顺序',
  '65a4ce155100cd7fa671b0f85c1df2cc': '是否有下一页',
  '442d73ebc936d3b74e41b901cce44a6e': '当前页',
  'fe00f5ed371bdec5801ac07f8bb564be': '最后页码',
  'eec5bfeff8012238efbf611fc22c32f6': '总条数',
  ...
  'e35abd1e31f244eb08d1f62e6f825df2': '绑定变量',
