...
export class TableCell extends React.Component<RendererProps> {
  ...
  render() {
    ...
    /** Column Schema中配置的优先级高于表格中的配置 */
    const canCellAccessSuperData =
      schema?.canCellAccessSuperData != null
        ? !!schema?.canCellAccessSuperData
        : this.props.canCellAccessSuperData !== false;
