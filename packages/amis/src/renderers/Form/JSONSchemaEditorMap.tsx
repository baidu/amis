...
import {JSONSchemaEditorMap} from 'amis-ui';
 ...
 * 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/json-schema-editor-map
 */
export interface JSONSchemaEditorControlMapSchema
...
export interface JSONSchemaEditorMapProps
...
export default class JSONSchemaEditorMapControl extends React.PureComponent<JSONSchemaEditorMapProps> {
  static defaultProps = {
...
export class JSONSchemaEditorMapRenderer extends JSONSchemaEditorMapControl {}
