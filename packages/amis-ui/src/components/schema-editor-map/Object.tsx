...
import {autobind, guid, JSONSchemaMap} from 'amis-core';
        ...
        {members.length ? (
          members.map((member, index) => (
            <SchemaEditorItem
                ...
                mini ? undefined : (
                  <>
                    ...
                    <InputBox
                      ...
                      value={
                        member.schema.title || member.schema.description || ''
                      }
              ...
              onFormulaChange={this.handlePropFormulaChange.bind(this, index)}
