...
test('Renderer: dragging selectable checkable selected hideCheckToggler multiple', () => {
  const schema: any = {
    type: 'page',
    body: {
      type: 'card',
  ...
  schema.body.selected = true;
  component.update(amisRender(schema, {}, makeEnv({})));

  schema.body.selected = false;
  component.update(amisRender(schema, {}, makeEnv({})));

  schema.body.hideCheckToggler = true;
  component.update(amisRender(schema, {}, makeEnv({})));

  schema.body.hideCheckToggler = false;
  component.update(amisRender(schema, {}, makeEnv({})));

  schema.body.multiple = true;
  component.update(amisRender(schema, {}, makeEnv({})));

  schema.body.multiple = false;
  component.update(amisRender(schema, {}, makeEnv({})));

  schema.body.checkable = false;
  component.update(amisRender(schema, {}, makeEnv({})));
});
