        ...
        render() {
            ...
            return (
                <ThemeContext.Provider value={theme}>
                    <ComposedComponent {...this.props as any /* todo, 解决这个类型问题 */} {...injectedProps} />
                </ThemeContext.Provider>
            );
        }
    }

    return hoistNonReactStatic(EnhancedComponent, ComposedComponent) as React.ComponentClass<Props> & {
        ComposedComponent: T;
    };
}
