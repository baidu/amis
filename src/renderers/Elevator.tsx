...
export interface ElevatorProps
    ...
    active?: string | number;
    floorRender?: (floor: FloorSchema, props: ElevatorProps, index: number) => JSX.Element;
}
...
export default class Elevator extends React.Component<ElevatorProps, ElevatorState> {
    ...
    renderFloor?: (floor: FloorSchema, props: ElevatorProps, index: number) => JSX.Element;
    ...
    constructor(props: ElevatorProps) {
        ...
        if (typeof props.active !== 'undefined') {
            ...
            const floor: FloorSchema = find(floors, floor => floor.anchor === props.active) as FloorSchema;
            active = floor && floor.anchor ? floor.anchor : (floors[0] && floors[0].anchor) || 0;
        }
