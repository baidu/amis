...
export default class TreeSelectControl extends React.Component<TreeSelectProps, TreeSelectState> {
    ...
    filterOptions(options: Array<Option>, keywords: string): Array<Option> {
        ...
        return options.map(option => {
            ...
            option.visible = !!matchSorter([option], keywords, {keys: [labelField || 'label', valueField || 'value']})
                .length;
        ...
        return selectedOptions.length ? (
            selectedOptions.map((item, index) =>
                multiple ? (
                    ...
                    >
                        <span className={cx('TreeSelect-valueIcon')} onClick={this.removeItem.bind(this, index)}>
                            ×
                        </span>
