 ...
 */
export interface QuarterRangeControlSchema extends FormBaseControl {
  /**
   * 指定为季度范围控件
   */
...
export default class QuarterRangeControl extends React.Component<MonthRangeProps> {
  static defaultProps = {
    format: 'X',
    joinValues: true,
    delimiter: ','
...
export class MonthRangeControlRenderer extends QuarterRangeControl {
  static defaultProps = {
    ...QuarterRangeControl.defaultProps,
    timeFormat: ''
  };
}
